...
public class MessageUtil {
	...
	public static String sendMessage(String mobilePhone) throws ClientException, IOException {
		...
		// 替换成你的AK
		// final String accessKeyId = "LTAIIHn9QvEFN6G8";// 你的accessKeyId,参考本文档步骤2
		final String accessKeyId = "khDhctI8wrvpiq9P";// 你的accessKeyId,参考本文档步骤2
		// final String accessKeySecret = "VLWem0fkANDgK5dTNb80P9VKXNWhMW";

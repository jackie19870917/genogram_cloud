...
public class FanNewsCultureController {
    ...
    */
     ...
     *@Description:
    */
    private Response<FanNewsCultureZipai> getFanNewsCultureZipaiResponse(FanNewsCultureZipai fanNewsCultureZipai,@ApiParam("token")@RequestParam(value = "token",defaultValue = "")String token) {
        try {
            //获取用户对象

...
public class FanIndexController {
    ...
    public Response<FanIndexSlidePic> insertOrUpdateFanIndexSlidePic(FanIndexSlidePic fanIndexSlidePic, @ApiParam("token")@RequestParam("token")String token) {
    ...
    public Response<FanIndexInfo> insertOrUpdateFanIndexInfo(IndexInfoVo indexInfoVo, @ApiParam("token")@RequestParam("token")String token) {
    ...
    public Response<FanIndexFamilySummarys> insertOrUpdateFanIndexFamilySummarys(@ApiParam("token")@RequestParam("token")String token,

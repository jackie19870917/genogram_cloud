...
(function ($) {
    ...
    MPreviewPPT.prototype = {
        ...
        __addEvent: function () {
            ...
            //拖拽事件
            DOM.scrollBtn.on('mousedown', function (event) {
                _this.__dragStart(event)
            });
            ...
            //上一页，下一页事件
            DOM.arrowTop.on('click', function () {
                _this.__pageJump('up')
            });
            DOM.pagePrev.on('click', function () {
                _this.__pageJump('up')
            });
            DOM.arrowBottom.on('click', function () {
                _this.__pageJump('down')
            });
            DOM.pageNext.on('click', function () {
                _this.__pageJump('down')
            });
            ...
            DOM.mediaPlay.on('dblclick', function () {
                _this.__full();
            });
        ...
        __full: function (bool) {
            ...
            if (has) {
                ...
                $(document).on('keyup', function (event) {
                    if (event.which == 27) _this.__full();
                });
